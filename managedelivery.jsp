  ...
  <nav class="navbar navbar-dark bg-dark fixed-top navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ml-auto">
            <a class="nav-link active" href="admin.html">&ensp;&ensp;Home&ensp;&ensp;<span
...
<table id="customers">
  ...
  <%@page import="java.sql.*"%>
    ...
    try
    {
        ...
        String str = "select * from my_users where role='delivery'";
            ...
            <tr>
              ...
              <td>
                <form action="update.jsp">
                  <button class="btn btn-primary" value="<%=uid%>,<%=name%>,<%=EMAIL%>,<%=MOBILE%>" name="update">Update</button>
                </form>
              </td>
              <td>
                <form action="del_user.jsp" method="post">
                  <button class="btn btn-danger" value="<%=uid%>" name="delete">Delete</button>
                </form>
              </td>
            </tr>
        <%}
